...
$(function(){
    ...
    $(".another .a1").hover(function(){
        $(this).css({background:"url('img/zhang/chaticon.png') no-repeat -5px -20px"});
    },
    function(){
        $(this).css({background:"url('img/zhang/chaticon.png') no-repeat -5px 0px"});
    });
    $(".another .a3").click(function(){
        $(".another").hide();
    });
    $(".another .a3").hover(function(){
            $(this).css({background:"url('img/zhang/chaticon.png') no-repeat -64px -20px"});
        },
        function(){
            $(this).css({background:"url('img/zhang/chaticon.png') no-repeat -64px 0px"});
        });
    $(".another .a2").click(function(){
        $(".another").css({height:"600px"});
        $(this).css({background:"url('img/zhang/chaticon.png') no-repeat -24px 0px"},function(){})
        });
    $(".another .a2").hover(function(){
            $(this).css({background:"url('img/zhang/chaticon.png') no-repeat -44px -20px"});
        },
        function(){
            $(this).css({background:"url('img/zhang/chaticon.png') no-repeat -44px 0px"});
        });
    ...
    $(window).scroll(function () {
        ...
        if (scrollTop == 0) {
            ...
            $(".tel").css({backgroundImage:"url(img/zhang/call.png)"})
        }
        else {
            $(".nav").stop(false,false).animate({backgroundColor:"rgb(255,255,255)"},300);
            $(".nav>ul>li>a").css({color:"#000"})
            $(".tel").css({backgroundImage:"url(img/zhang/call-black.png)"})
        }
    });
    $(".nav1").mouseenter(
        function () {
